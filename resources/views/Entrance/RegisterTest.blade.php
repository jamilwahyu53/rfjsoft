...
<div class="container h-100 m-0 p-0">
    <div class="row h-100 justify-content-md-center align-items-center m-0 p-0" style="min-height: 100vh;">
        <div class="col-lg-6 col-md-6 col-sm-12 mx-auto border shadow rounded m-0 p-0 ">
            <div class="row">
    ...
    @include('EntranceComponents.ModalQr', ['id' => 'modalQr', 'title' => 'Download QR Untuk Ditukar Dengan Ticket'])
    ...
    setup() {
        ...
        const field_register = reactive([
            ...
            },
            {
                ...
                col: "6",
                get hidden() {
                    return form_register.mesengger !== 'undangan';
                },
                get disabled() {
                    return form_register.mesengger !== 'undangan';
                }
            },
            {
                ...
                col: "6",
                get hidden() {
                    return form_register.mesengger !== 'ormas';
                },
                get disabled() {
                    return form_register.mesengger !== 'ormas';
                }
        ...
        watch(() => form_register.mesengger, (newVal) => {
            if (newVal !== 'ormas') {
                form_register.status_mesengger_other = '';
            }
            if (newVal !== 'undangan') {
                form_register.status_mesengger = '';
            }
        });
